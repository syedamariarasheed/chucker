...
import com.chuckerteam.chucker.internal.ui.logs.ChuckerLogsFragment
...
internal class HomePageAdapter(context: Context, fragmentManager: FragmentManager) :
    ...
    } else if (position == SCREEN_LOGS_INDEX) {
        ChuckerLogsFragment.newInstance()
    }else {
